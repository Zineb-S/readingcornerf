...
const Login = () => {
  ...
  const [signuppassword, setPasswordSignUp] = useState("");
  ...
  const handleSignUp = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`https://readingcornerb.herokuapp.com/api/users/create`, { email: signupemail, password: signuppassword, fname: fname, lname: lname, role: role });
      if (res) {
        ...
        <MDBContainer id='authContainer' className="p-3 my-5 d-flex flex-column w-50">
          ...
          <MDBTabsContent>
            ...
            <MDBTabsPane show={justifyActive === 'tab2'}>
              ...
              <MDBInput wrapperClass='mb-4' placeholder='Last Name' id='form1' type='text' onChange={(e) => setLname(e.target.value)}  />
              <MDBInput wrapperClass='mb-4' placeholder='Email' id='form1' type='email'  onChange={(e) => setEmailSignUp(e.target.value)} />
              <MDBInput wrapperClass='mb-4' placeholder='Password' id='form1' type='password'  onChange={(e) => setPasswordSignUp(e.target.value)} />
